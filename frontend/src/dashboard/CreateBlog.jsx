...
function CreateBlog() {
  ...
  return (
    <div>
      <div className="min-h-screen flex justify-center items-start md:items-center py-10 bg-gray-50">
  <div className="w-full max-w-2xl md:max-w-3xl lg:max-w-4xl mx-auto bg-white p-6 border rounded-lg shadow-lg">
